...
render_vars='${PUBLIC_IP} ${OPERATOR_HOST} ${OPERATOR_PORT} ${OPERATOR_OUTBOUND_PROXY} ${OPERATOR_USERNAME} ${OPERATOR_PASSWORD} ${OPERATOR_FROM_DOMAIN} ${OPERATOR_MATCH_IPS} ${OPERATOR_CALLERID} ${RINGOSTAT_USERNAME} ${RINGOSTAT_PASSWORD} ${OUTBOUND_STRIP_PREFIX}'
